...
<footer  className="px-3 py-8 bg-gray-800 text-2 text-gray-500 dark:text-gray-200 transition-colors duration-200">
        ...
        <div className="mt-4 md:mt-0 flex flex-col md:flex-row">
            <nav className="flex-1 flex flex-col items-center justify-center md:items-end md:border-r border-gray-100 md:pr-5">
                <a aria-current="page" href="#" className="hover:text-gray-700 dark:hover:text-white">
                   Gali No 1,Opp Civil Hospital ,Ghanta Ghar Chowk Bhiwani
                </a>
                <a aria-current="page" href="#" className="hover:text-gray-700 dark:hover:text-white">
                    Contact Details : 9996211406
                </a>
                <a aria-current="page" href="#" className="hover:text-gray-700 dark:hover:text-white">
                    Store Timing-  9am to 8pm
                </a>
            </nav>
            ...
            <div className="mt-4 md:mt-0 flex-1 flex items-center justify-center md:border-r border-gray-100">
                <a className="ml-4 hover:text-primary-gray-20" href="#">
                    ...
                    <svg width="30" height="30" fill="currentColor" className="text-xl hover:text-gray-800 dark:hover:text-white transition-colors duration-200" viewBox="0 0 2048 1792" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="mt-7 md:mt-0 flex-1 flex flex-col items-center justify-center md:items-start md:pl-5">
                ...
                <span className="mt-7 md:mt-1">
                    Created by
                    <a className="underline hover:text-primary-gray-20" href="https://www.linkedin.com/in/kanishak-mahendiratta-a61969193" >
                        Kanishak
                    </a>
                </span>
            </div>
